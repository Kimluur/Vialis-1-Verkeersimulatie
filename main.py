...
def latllongtocoord(long,lat):
    ...
    return long ,lat
def loadLongLat(alleSensoren,dfkruis):
    for column in dfkruis[['sensorPosition.lat', 'sensorPosition.long']]:
    ...
    for i in range(len(long)):
        ...
        alleSensoren.append(Sensor((latlngToScreenXY(a, b)), (0, 255, 255), lusSizeDefault[0], lusSizeDefault[1]))

loadLongLat(alleSensoren,dfKruis1)
